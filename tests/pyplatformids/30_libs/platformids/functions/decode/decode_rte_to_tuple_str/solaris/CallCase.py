...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = platformids.decode_rte_to_tuple_str(platformids.dist.solaris.RTE_SOLARIS112)
        resx = (
            platformids.num2rte[platformids.RTE_POSIX],
            platformids.num2rte[platformids.RTE_UNIX],
            platformids.num2rte[platformids.RTE_SOLARIS],
            platformids.num2rte[platformids.dist.solaris.RTE_SOLARIS112],
            )
