...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = platformids.decode_rte_to_tuple_str(platformids.dist.fedora.RTE_FEDORA27)
        resx = (
    ...
    def testCase020(self):
        res = platformids.decode_rte_to_tuple_str(platformids.dist.fedora.RTE_FEDORA29)
        resx = (
            platformids.num2rte[platformids.RTE_POSIX],
            platformids.num2rte[platformids.RTE_LINUX],
            platformids.num2rte[platformids.RTE_FEDORA],
            platformids.num2rte[platformids.dist.fedora.RTE_FEDORA29],
            )
        self.assertEqual(res, resx)
