...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = platformids.decode_rte_to_tuple_str(platformids.dist.darwin.RTE_OSX1068)
        resx = (
            platformids.num2rte[platformids.RTE_POSIX],
            platformids.num2rte[platformids.RTE_DARWIN],
            platformids.num2rte[platformids.RTE_OSX],
            platformids.num2rte[platformids.dist.darwin.RTE_OSX1068],
            )
