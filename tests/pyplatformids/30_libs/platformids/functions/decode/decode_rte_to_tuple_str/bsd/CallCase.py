...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = platformids.decode_rte_to_tuple_str(platformids.dist.openbsd.RTE_OPENBSD64)
        resx = (
            platformids.num2rte[platformids.RTE_POSIX],
            platformids.num2rte[platformids.RTE_BSD],
            platformids.num2rte[platformids.RTE_OPENBSD],
            platformids.num2rte[platformids.dist.openbsd.RTE_OPENBSD64],
            )
