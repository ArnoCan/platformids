...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = platformids.decode_rte_dist_to_num(
            platformids.RTE_POSIX | platformids.RTE_LINUX | platformids.RTE_CENTOS | 0x1234
            )
        resx = platformids.RTE_CENTOS
        self.assertEqual(res, resx)

    def testCase020(self):
        res = platformids.decode_rte_dist_to_num(platformids.RTE_CENTOS)
        resx = platformids.RTE_CENTOS
        self.assertEqual(res, resx)
