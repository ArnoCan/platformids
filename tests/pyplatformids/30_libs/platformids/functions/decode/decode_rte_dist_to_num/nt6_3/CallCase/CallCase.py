...
class CallUnits(unittest.TestCase):
    ...
    def testCase020(self):
        res = decode_rte_dist_to_num(platformids.dist.windows.RTE_WIN2012R2)
        resx = platformids.dist.windows.RTE_NT63
        self.assertEqual(res, resx)

        res = decode_rte_dist_to_num(platformids.dist.windows.RTE_WIN81)
        resx = platformids.dist.windows.RTE_NT63
        self.assertEqual(res, resx)
