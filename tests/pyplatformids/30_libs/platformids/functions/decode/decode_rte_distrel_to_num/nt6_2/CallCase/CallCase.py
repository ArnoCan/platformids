...
class CallUnits(unittest.TestCase):
    ...
    def testCase020(self):
        res = decode_rte_distrel_to_num(platformids.dist.windows.RTE_WIN8)
        resx = platformids.dist.windows.RTE_WIN8 & platformids.RTE_DISTREL
        self.assertEqual(res, resx)

    def testCase030(self):
        res = decode_rte_distrel_to_num(platformids.dist.windows.RTE_WIN8)
        resx = platformids.dist.windows.RTE_NT62 + 9200
        self.assertEqual(res, resx)
