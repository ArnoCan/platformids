...
import unittest
import platformids.custom.pentoo
...
class CallUnits(unittest.TestCase):
    ...
    def testCase020(self):
        res = decode_rte_distrel_to_num(platformids.custom.pentoo.RTE_PENTOO20190)
        resx = platformids.custom.pentoo.RTE_PENTOO20190 & platformids.RTE_DISTREL
        self.assertEqual(res, resx)

    def testCase030(self):
        res = decode_rte_distrel_to_num(platformids.custom.pentoo.RTE_PENTOO20190)
        resx = platformids.custom.pentoo.RTE_PENTOO + 0x00006200
        self.assertEqual(res, resx)
