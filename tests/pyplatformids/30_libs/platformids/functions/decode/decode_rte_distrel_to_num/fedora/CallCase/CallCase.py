...
class CallUnits(unittest.TestCase):
    ...
    def testCase020(self):
        res = decode_rte_distrel_to_num(platformids.dist.fedora.RTE_FEDORA27)
        resx = platformids.dist.fedora.RTE_FEDORA27 & platformids.RTE_DISTREL
        self.assertEqual(res, resx)

    def testCase030(self):
        res = decode_rte_distrel_to_num(platformids.dist.fedora.RTE_FEDORA27)
        resx = platformids.RTE_FEDORA + 0x00006c00
        self.assertEqual(res, resx)
