...
class CallUnits(unittest.TestCase):
    ...
    def testCase020(self):
        res = decode_rte_distrel_to_num(platformids.custom.reactos.RTE_REACTOS0411)
        resx = platformids.custom.reactos.RTE_REACTOS0411 & platformids.RTE_DISTREL
        self.assertEqual(res, resx)

    def testCase030(self):
        res = decode_rte_distrel_to_num(platformids.custom.reactos.RTE_REACTOS0411)
        resx = platformids.custom.reactos.RTE_REACTOS5_2 + 0x0000008b
        self.assertEqual(res, resx)
