...
import unittest
import platformids.custom.trueos
...
class CallUnits(unittest.TestCase):
    ...
    def testCase020(self):
        res = decode_rte_distrel_to_num(platformids.custom.trueos.RTE_TRUEOS1812)
        resx = platformids.custom.trueos.RTE_TRUEOS1812 & platformids.RTE_DISTREL
        self.assertEqual(res, resx)

    def testCase030(self):
        res = decode_rte_distrel_to_num(platformids.custom.trueos.RTE_TRUEOS1812)
        resx = platformids.custom.trueos.RTE_TRUEOS + 0x00004980
        self.assertEqual(res, resx)
