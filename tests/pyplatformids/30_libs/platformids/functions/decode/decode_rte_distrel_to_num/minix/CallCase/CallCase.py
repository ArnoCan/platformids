...
import unittest
import platformids.custom.minix
...
class CallUnits(unittest.TestCase):
    ...
    def testCase020(self):
        res = decode_rte_distrel_to_num(platformids.custom.minix.RTE_MINIX330)
        resx = platformids.custom.minix.RTE_MINIX330 & platformids.RTE_DISTREL
        self.assertEqual(res, resx)

    def testCase030(self):
        res = decode_rte_distrel_to_num(platformids.custom.minix.RTE_MINIX330)
        resx = platformids.custom.minix.RTE_MINIX + 0x00000660
        self.assertEqual(res, resx)
