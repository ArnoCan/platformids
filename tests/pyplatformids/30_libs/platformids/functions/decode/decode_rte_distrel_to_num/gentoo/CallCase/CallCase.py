...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = decode_rte_distrel_to_num(platformids.dist.gentoo.RTE_GENTOO20181204)
        resx = platformids.dist.gentoo.RTE_GENTOO + 0x00001c00
        self.assertTrue(res, resx)

    def testCase020(self):
        res = decode_rte_distrel_to_num(platformids.dist.gentoo.RTE_GENTOO20181204)
        resx = platformids.dist.gentoo.RTE_GENTOO20181204 & platformids.RTE_DISTREL
        self.assertTrue(res, resx)
