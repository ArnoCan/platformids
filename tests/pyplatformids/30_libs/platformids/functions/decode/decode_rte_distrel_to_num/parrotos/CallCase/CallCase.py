...
import unittest
import platformids.custom.parrot
...
class CallUnits(unittest.TestCase):
    ...
    def testCase020(self):
        res = decode_rte_distrel_to_num(platformids.custom.parrot.RTE_PARROT451)
        resx = platformids.custom.parrot.RTE_PARROT451 & platformids.RTE_DISTREL
        self.assertEqual(res, resx)

    def testCase030(self):
        res = decode_rte_distrel_to_num(platformids.custom.parrot.RTE_PARROT451)
        resx = platformids.custom.parrot.RTE_PARROT + 0x000010a1
        self.assertEqual(res, resx)
