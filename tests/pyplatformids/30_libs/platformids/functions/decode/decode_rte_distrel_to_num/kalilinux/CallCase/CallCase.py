...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = decode_rte_distrel_to_num(platformids.net.kali.RTE_KALI201911)
        resx = platformids.net.kali.RTE_KALI + 0x00001c00
        self.assertTrue(res, resx)

    def testCase020(self):
        res = decode_rte_distrel_to_num(platformids.net.kali.RTE_KALI201911)
        resx = platformids.net.kali.RTE_KALI201911& platformids.RTE_DISTREL
        self.assertTrue(res, resx)
