...
import unittest
import platformids.custom.slackware
...
class CallUnits(unittest.TestCase):
    ...
    def testCase020(self):
        res = decode_rte_distrel_to_num(platformids.custom.slackware.RTE_SLACK142)
        resx = platformids.custom.slackware.RTE_SLACK142 & platformids.RTE_DISTREL
        self.assertEqual(res, resx)

    def testCase030(self):
        res = decode_rte_distrel_to_num(platformids.custom.slackware.RTE_SLACK142)
        resx = platformids.custom.slackware.RTE_SLACK + 0x00003840
        self.assertEqual(res, resx)
