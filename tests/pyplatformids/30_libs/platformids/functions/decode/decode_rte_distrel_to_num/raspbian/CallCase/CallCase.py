...
class CallUnits(unittest.TestCase):
    ...
    def testCase020(self):
        res = decode_rte_distrel_to_num(platformids.embed.raspbian.RTE_RASPBIAN96)
        resx = platformids.embed.raspbian.RTE_RASPBIAN96 & platformids.RTE_DISTREL
        self.assertEqual(res, resx)

    def testCase030(self):
        res = decode_rte_distrel_to_num(platformids.embed.raspbian.RTE_RASPBIAN96)
        resx = platformids.embed.raspbian.RTE_RASPBIAN + 0x000024c0
        self.assertEqual(res, resx)
