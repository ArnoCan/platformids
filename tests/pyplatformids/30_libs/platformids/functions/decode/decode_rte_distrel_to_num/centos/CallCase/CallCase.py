...
class CallUnits(unittest.TestCase):
    ...
    def testCase020(self):
        res = decode_rte_distrel_to_num(platformids.dist.centos.RTE_CENTOS7)
        resx = platformids.dist.centos.RTE_CENTOS7 & platformids.RTE_DISTREL
        self.assertTrue(res, resx)

    def testCase030(self):
        res = decode_rte_distrel_to_num(platformids.dist.centos.RTE_CENTOS7)
        resx = platformids.RTE_CENTOS + 0x00001c00
        self.assertTrue(res, resx)
