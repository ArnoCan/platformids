...
class CallUnits(unittest.TestCase):
    ...
    def testCase020(self):
        res = decode_rte_distrel_to_num(platformids.dist.ubuntu.RTE_UBUNTU1810)
        resx = platformids.dist.ubuntu.RTE_UBUNTU1810 & platformids.RTE_DISTREL
        self.assertEqual(res, resx)

    def testCase030(self):
        res = decode_rte_distrel_to_num(platformids.dist.ubuntu.RTE_UBUNTU1810)
        resx = platformids.dist.ubuntu.RTE_UBUNTU + 0x00004940
        self.assertEqual(res, resx)
