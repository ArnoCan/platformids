...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = decode_rte_distrel_to_num(platformids.embed.armbian.RTE_ARMBIAN550)
        resx = platformids.embed.armbian.RTE_ARMBIAN + 0x00001c00
        self.assertTrue(res, resx)

    def testCase020(self):
        res = decode_rte_distrel_to_num(platformids.embed.armbian.RTE_ARMBIAN550)
        resx = platformids.embed.armbian.RTE_ARMBIAN550 & platformids.RTE_DISTREL
        self.assertTrue(res, resx)
