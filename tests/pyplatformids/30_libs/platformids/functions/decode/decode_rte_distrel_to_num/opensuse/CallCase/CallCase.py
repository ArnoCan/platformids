...
class CallUnits(unittest.TestCase):
    ...
    def testCase020(self):
        res = decode_rte_distrel_to_num(platformids.dist.opensuse.RTE_OPENSUSE151)
        resx = platformids.dist.opensuse.RTE_OPENSUSE151 & platformids.RTE_DISTREL
        self.assertEqual(res, resx)

    def testCase030(self):
        res = decode_rte_distrel_to_num(platformids.dist.opensuse.RTE_OPENSUSE151)
        resx = platformids.dist.opensuse.RTE_OPENSUSE + 0x00003c20
        self.assertEqual(res, resx)
