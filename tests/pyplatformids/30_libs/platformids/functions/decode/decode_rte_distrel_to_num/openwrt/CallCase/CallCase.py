...
class CallUnits(unittest.TestCase):
    ...
    def testCase020(self):
        res = decode_rte_distrel_to_num(platformids.net.openwrt.RTE_OPENWRT18061)
        resx = platformids.net.openwrt.RTE_OPENWRT18061 & platformids.RTE_DISTREL
        self.assertEqual(res, resx)

    def testCase030(self):
        res = decode_rte_distrel_to_num(platformids.net.openwrt.RTE_OPENWRT18061)
        resx = platformids.net.openwrt.RTE_OPENWRT + 0x000048c1
        self.assertEqual(res, resx)
