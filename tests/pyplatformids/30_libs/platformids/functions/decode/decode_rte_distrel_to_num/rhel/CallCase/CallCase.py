...
class CallUnits(unittest.TestCase):
    ...
    def testCase020(self):
        res = decode_rte_distrel_to_num(platformids.dist.rhel.RTE_RHEL76)
        resx = platformids.dist.rhel.RTE_RHEL76 & platformids.RTE_DISTREL
        self.assertEqual(res, resx)

    def testCase030(self):
        res = decode_rte_distrel_to_num(platformids.dist.rhel.RTE_RHEL76)
        resx = platformids.dist.rhel.RTE_RHEL + 0x00001cc0
        self.assertEqual(res, resx)
