...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = decode_rte_distrel_to_num(platformids.custom.blackarch.RTE_BLACKARCH20180)
        resx = platformids.custom.blackarch.RTE_BLACKARCH + 0x00001c00
        self.assertTrue(res, resx)

    def testCase020(self):
        res = decode_rte_distrel_to_num(platformids.custom.blackarch.RTE_BLACKARCH20180)
        resx = platformids.custom.blackarch.RTE_BLACKARCH20180 & platformids.RTE_DISTREL
        self.assertTrue(res, resx)
