...
class CallUnits(unittest.TestCase):
    ...
    def testCase020(self):
        res = decode_rte_distrel_to_num(platformids.dist.oraclelinux.RTE_OEL7U6)
        resx = platformids.dist.oraclelinux.RTE_OEL7U6 & platformids.RTE_DISTREL
        self.assertEqual(res, resx)

    def testCase030(self):
        res = decode_rte_distrel_to_num(platformids.dist.oraclelinux.RTE_OEL7U6)
        resx = platformids.dist.oraclelinux.RTE_OEL + 0x00001cc0
        self.assertEqual(res, resx)
