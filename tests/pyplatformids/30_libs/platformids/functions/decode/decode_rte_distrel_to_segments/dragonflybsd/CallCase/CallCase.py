...
import unittest
import platformids.custom.dragonbsd
...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = decode_rte_distrel_to_segments(platformids.custom.dragonbsd.RTE_DRAGONBSD54)
        resx = platformids.custom.dragonbsd.RTE_DRAGONFLYBSD + 0x00001c00
        self.assertTrue(res, resx)

    def testCase020(self):
        res = decode_rte_distrel_to_segments(platformids.custom.dragonbsd.RTE_DRAGONBSD54)
        resx = platformids.custom.dragonbsd.RTE_DRAGONBSD54 & platformids.RTE_DISTREL
        self.assertTrue(res, resx)
