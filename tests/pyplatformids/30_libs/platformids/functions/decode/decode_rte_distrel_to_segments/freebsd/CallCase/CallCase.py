...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = decode_rte_distrel_to_segments(platformids.dist.freebsd.RTE_FREEBSD112)
        resx = platformids.dist.freebsd.RTE_FREEBSD + 0x00001c00
        self.assertTrue(res, resx)

    def testCase020(self):
        res = decode_rte_distrel_to_segments(platformids.dist.freebsd.RTE_FREEBSD112)
        resx = platformids.dist.freebsd.RTE_FREEBSD112 & platformids.RTE_DISTREL
        self.assertTrue(res, resx)
