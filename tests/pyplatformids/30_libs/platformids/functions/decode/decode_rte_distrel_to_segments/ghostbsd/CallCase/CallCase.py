...
import unittest
import platformids.custom.ghostbsd
...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = decode_rte_distrel_to_segments(platformids.custom.ghostbsd.RTE_GHOSTBSD194)
        resx = platformids.custom.ghostbsd.RTE_GHOSTBSD + 0x00001c00
        self.assertTrue(res, resx)

    def testCase020(self):
        res = decode_rte_distrel_to_segments(platformids.custom.ghostbsd.RTE_GHOSTBSD194)
        resx = platformids.custom.ghostbsd.RTE_GHOSTBSD194 & platformids.RTE_DISTREL
        self.assertTrue(res, resx)
