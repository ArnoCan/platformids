...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = decode_rte_distrel_to_segments(platformids.dist.cygwin.RTE_CYGWIN290)
        resx = platformids.RTE_CYGWINNT + 0x00001c00
        self.assertTrue(res, resx)

    def testCase020(self):
        res = decode_rte_distrel_to_segments(platformids.dist.cygwin.RTE_CYGWIN290)
        resx = platformids.dist.cygwin.RTE_CYGWIN290 & platformids.RTE_DISTREL
        self.assertTrue(res, resx)
