...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = decode_rte_distrel_to_segments(platformids.dist.debian.RTE_DEBIAN95)
        resx = platformids.RTE_DEBIAN + 0x00001c00
        self.assertTrue(res, resx)

    def testCase020(self):
        res = decode_rte_distrel_to_segments(platformids.dist.debian.RTE_DEBIAN95)
        resx = platformids.dist.debian.RTE_DEBIAN95 & platformids.RTE_DISTREL
        self.assertTrue(res, resx)
