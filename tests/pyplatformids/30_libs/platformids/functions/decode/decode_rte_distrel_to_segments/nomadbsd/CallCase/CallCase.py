...
import unittest
import platformids.custom.nomadbsd
...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = decode_rte_distrel_to_segments(platformids.custom.nomadbsd.RTE_NOMADBSD12)
        resx = platformids.custom.nomadbsd.RTE_NOMADBSD + 0x00001c00
        self.assertTrue(res, resx)

    def testCase020(self):
        res = decode_rte_distrel_to_segments(platformids.custom.nomadbsd.RTE_NOMADBSD12)
        resx = platformids.custom.nomadbsd.RTE_NOMADBSD12 & platformids.RTE_DISTREL
        self.assertTrue(res, resx)
