...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = decode_rte_distrel_to_segments(platformids.dist.netbsd.RTE_NETBSD71)
        resx = platformids.dist.netbsd.RTE_NETBSD + 0x00001c00
        self.assertTrue(res, resx)

    def testCase020(self):
        res = decode_rte_distrel_to_segments(platformids.dist.netbsd.RTE_NETBSD71)
        resx = platformids.dist.netbsd.RTE_NETBSD71 & platformids.RTE_DISTREL
        self.assertTrue(res, resx)
