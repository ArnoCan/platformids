...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = platformids.decode_rte_ostype_to_num(
            platformids.RTE_EMBEDDED | platformids.embed.micropython.RTE_MICROPYTHON
            )
        resx = platformids.embed.micropython.RTE_MICROPYTHON
        self.assertEqual(res, resx)

    def testCase020(self):
        res = platformids.decode_rte_ostype_to_num(platformids.embed.micropython.RTE_MICROPYTHON)
        resx = platformids.embed.micropython.RTE_MICROPYTHON
        self.assertEqual(res, resx)
