...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = platformids.decode_rte_ostype_to_num(
            platformids.RTE_WINDOWS | platformids.custom.reactos.RTE_REACTOS | platformids.custom.reactos.RTE_REACTOS5_2 | 1234
            )
        resx = platformids.custom.reactos.RTE_REACTOS
        self.assertEqual(res, resx)

    def testCase020(self):
        res = platformids.decode_rte_ostype_to_num(platformids.custom.reactos.RTE_REACTOS0411)
        resx = platformids.custom.reactos.RTE_REACTOS
        self.assertEqual(res, resx)
