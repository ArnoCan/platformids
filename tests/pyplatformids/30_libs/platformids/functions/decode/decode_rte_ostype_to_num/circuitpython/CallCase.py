...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = platformids.decode_rte_ostype_to_num(
            platformids.RTE_EMBEDDED | platformids.embed.circuitpython.RTE_CIRCUITPYTHON
            )
        resx = platformids.embed.circuitpython.RTE_MICROPYTHON
        self.assertEqual(res, resx)

    def testCase020(self):
        res = platformids.decode_rte_ostype_to_num(platformids.embed.circuitpython.RTE_CIRCUITPYTHON)
        resx = platformids.embed.circuitpython.RTE_MICROPYTHON
        self.assertEqual(res, resx)
