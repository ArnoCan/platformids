...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = platformids.encode_rte_segments_to_32bit(
            ...
            dist=((platformids.RTE_CENTOS & platformids.RTE_DIST_B) >> 16),
            distrel=(7 << 10 | 6 << 5) 
            )
        resx = platformids.dist.centos.RTE_CENTOS76
        self.assertEqual(res, resx)

    def testCase020(self):
        res = platformids.encode_rte_segments_to_32bit(
            category=((platformids.RTE_POSIX & platformids.RTE_CATEGORY_B) >> 28),
            ostype=((platformids.RTE_BSD& platformids.RTE_OSTYPE_B) >> 23),
            dist=((platformids.RTE_OPENBSD & platformids.RTE_DIST_B) >> 16),
            distrel=(6 << 10 | 4 << 5) 
            )
        resx = platformids.dist.openbsd.RTE_OPENBSD64
        self.assertEqual(res, resx)
    ...
    def testCase040(self):
        res = platformids.encode_rte_segments_to_32bit(
            category=((platformids.RTE_POSIX & platformids.RTE_CATEGORY_B) >> 28),
            ostype=((platformids.RTE_LINUX& platformids.RTE_OSTYPE_B) >> 23),
            dist=((platformids.RTE_ARCHLINUX& platformids.RTE_DIST_B) >> 16),
    ...
    def testCase050(self):
        res = platformids.encode_rte_segments_to_32bit(
            category=((platformids.RTE_POSIX & platformids.RTE_CATEGORY_B) >> 28),
            ostype=((platformids.RTE_LINUX& platformids.RTE_OSTYPE_B) >> 23),
            dist=((platformids.RTE_ARMBIAN& platformids.RTE_DIST_B) >> 16),
            distrel=(5 << 11 | 50 << 3)
            ) 
