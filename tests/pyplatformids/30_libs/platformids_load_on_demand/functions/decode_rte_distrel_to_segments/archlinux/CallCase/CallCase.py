...
class CallUnits(unittest.TestCase):
    ...
    def testCase020(self):
        res = decode_rte_distrel_to_segments(platformids.dist.archlinux.RTE_ARCHLINUX20180601)
        resx = (2018, 6, 1)
        self.assertTrue(res, resx)

    def testCase030(self):
        res = decode_rte_distrel_to_segments(platformids.dist.archlinux.RTE_ARCHLINUX20181201)
        resx = (2018, 12, 1)
        self.assertTrue(res, resx)
