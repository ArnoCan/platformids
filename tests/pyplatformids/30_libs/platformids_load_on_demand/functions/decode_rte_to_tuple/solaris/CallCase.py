...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = platformids.decode_rte_to_tuple(platformids.dist.solaris.RTE_SOLARIS11)
        resx = (
            platformids.RTE_POSIX,
            platformids.RTE_UNIX,
            platformids.dist.solaris.RTE_SOLARIS,
            platformids.dist.solaris.RTE_SOLARIS11,
            )
