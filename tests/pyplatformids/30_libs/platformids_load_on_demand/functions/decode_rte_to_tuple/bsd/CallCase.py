...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = platformids.decode_rte_to_tuple(platformids.dist.freebsd.RTE_FREEBSD112)
        resx = (
            platformids.RTE_POSIX,
            platformids.RTE_BSD,
            platformids.dist.freebsd.RTE_FREEBSD,
            platformids.dist.freebsd.RTE_FREEBSD112,
            )
