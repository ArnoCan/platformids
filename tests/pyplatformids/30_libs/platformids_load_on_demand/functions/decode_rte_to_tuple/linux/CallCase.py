...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = platformids.decode_rte_to_tuple(platformids.dist.alpinelinux.RTE_ALPINELIN381)
        resx = (
            platformids.RTE_POSIX,
            platformids.RTE_LINUX,
            platformids.dist.alpinelinux.RTE_ALPINELIN,
            platformids.dist.alpinelinux.RTE_ALPINELIN381,
            )
