...
class CallUnits(unittest.TestCase):
    ...
    def testCase020(self):
        #
        # generic test of segments
        #
        
        res = fetch_platform_distribution() # ('fedora27', '27', 'Fedora27', 'Fedora', (27, 0, 0), 'fedora')
        
        self.assertTrue(rte2num[res[0]] == RTE)
        self.assertTrue(rte2num[res[5]] == RTE & RTE_DIST)

        self.assertTrue(res[4] == decode_rte_distrel_to_segments(RTE))
