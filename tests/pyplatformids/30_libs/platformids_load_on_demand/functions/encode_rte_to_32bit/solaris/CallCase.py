...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = platformids.encode_rte_to_32bit(
            distrel=platformids.dist.solaris.RTE_SOLARIS113
            )
        resx = platformids.dist.solaris.RTE_SOLARIS113
        self.assertEqual(res, resx)

    def testCase020(self):
        res = platformids.encode_rte_to_32bit(
            distrel=platformids.num2rte[platformids.dist.solaris.RTE_SOLARIS113]
            )
        resx = platformids.dist.solaris.RTE_SOLARIS113
        self.assertEqual(res, resx)
