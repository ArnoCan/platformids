...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = platformids.decode_rte_to_tuple_str(platformids.dist.oraclelinux.RTE_OEL6U9)
        resx = (
            platformids.num2rte[platformids.RTE_POSIX],
            platformids.num2rte[platformids.RTE_LINUX],
            platformids.num2rte[platformids.dist.oraclelinux.RTE_OEL],
            platformids.num2rte[platformids.dist.oraclelinux.RTE_OEL6U9],
            )
