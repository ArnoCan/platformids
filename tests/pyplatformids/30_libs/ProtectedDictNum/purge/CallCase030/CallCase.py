...
#        super(CallUnits, cls).setUpClass()(self)
    ...
    def testCase040(self):
        self.assertRaises(PlatformIDsEnumerationError, self.dn.purge, minrel=10)

    def testCase050(self):
        res = self.dn.add_enum()
        self.assertTrue(res in (1002, 1004,))
    ...
    def testCase071(self):
        self.assertTrue(self.dn.delete_enum(1000))  # purges automatic by delete_enum
