...
import platformids
from platformids import RTE_POSIX, decode_rte_category_to_num
from platformids import RTE_CENTOS, RTE_FEDORA, RTE_RHEL, RTE_DEBIAN, RTE_BSD
from platformids.dist.solaris import RTE_SOLARIS 
...
class CallUnits(unittest.TestCase):
    ...
    def testCase011(self):
        self.assertEqual(platformids.decode_rte_category_to_num("posix"), RTE_POSIX)

    def testCase012(self):
        self.assertEqual(platformids.decode_rte_category_to_num(RTE_POSIX), RTE_POSIX)
    ...
    def testCase061(self):
        self.assertEqual(platformids.decode_rte_category_to_num("solaris"), RTE_POSIX)

    def testCase062(self):
        self.assertEqual(platformids.decode_rte_category_to_num(RTE_SOLARIS), RTE_POSIX)

    def testCase071(self):
        self.assertEqual(platformids.decode_rte_category_to_num("bsd"), RTE_POSIX)

    def testCase072(self):
        self.assertEqual(platformids.decode_rte_category_to_num(RTE_BSD), RTE_POSIX)
