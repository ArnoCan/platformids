...
import platformids
from platformids import RTE_LINUX, RTE_UNIX, RTE_BSD, decode_rte_ostype_to_num
...
class CallUnits(unittest.TestCase):
    ...
    def testCase061(self):
        self.assertEqual(platformids.decode_rte_ostype_to_num("solaris"), RTE_UNIX)

    def testCase062(self):
        self.assertEqual(platformids.decode_rte_ostype_to_num(RTE_SOLARIS), RTE_UNIX)

    def testCase071(self):
        self.assertEqual(platformids.decode_rte_ostype_to_num("bsd"), RTE_BSD)

    def testCase072(self):
        self.assertEqual(platformids.decode_rte_ostype_to_num(RTE_BSD), RTE_BSD)
