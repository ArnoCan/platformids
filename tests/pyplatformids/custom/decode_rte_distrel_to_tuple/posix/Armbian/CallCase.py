...
import platformids  # @UnusedImport
...
class CallUnits(unittest.TestCase):
    ...
    def testCase010(self):
        res = platformids.decode_rte_distrel_to_segments(
            platformids.RTE_POSIX | platformids.RTE_LINUX | platformids.embed.armbian.RTE_ARMBIAN | 0x00002990
            )
        resx = (5, 50, 0,)
